...
extension CuriosityViewModel: RandomAccessCollection {
...
extension CuriosityViewModel : InfiniteScrollable {
    ...
    func fetchMorePhotos(currentItem : PhotoModel? = nil) {
        ...
        let url = "\(ApplicationConstants.curiosityURLString)\(nextPageIndex)"
