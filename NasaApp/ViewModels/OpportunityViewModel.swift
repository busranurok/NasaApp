...
extension OpportunityViewModel: RandomAccessCollection {
...
extension OpportunityViewModel : InfiniteScrollable {
    ...
    func fetchMorePhotos(currentItem : PhotoModel? = nil) {
        ...
        let url = "\(ApplicationConstants.opportunityURLString)\(nextPageIndex)"
